...
@section('form')
    ...
    <div class="col-md-6">
        <div class="input-group mb-3">
            ...
            <input name="position" type="text" class="form-control" placeholder="Pozisyon giriniz"
                required />
        </div>
    </div>
    <!-- Şirket -->
    <div class="col-md-6">
        <div class="input-group mb-3">
            ...
            <input name="company" type="text" class="form-control" placeholder="Şirket adı giriniz"
                required />
        </div>
    </div>
    <!-- Başlangıç Tarihi -->
    <div class="col-md-6">
        <div class="input-group mb-3">
            ...
            <input name="start_date" type="date" class="form-control" placeholder="Başlangıç tarihi"
